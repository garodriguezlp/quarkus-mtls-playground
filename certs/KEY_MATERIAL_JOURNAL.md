# Key Material Creation Journal

This journal documents, step-by-step, the exact commands used to create the demo certificates, keystores, and truststores. All artifacts were created with `keytool` and stored in the `certs/` directory. Passwords are intentionally simple for an educational demo.
...
keytool -genkeypair -alias ca -keyalg RSA -keysize 2048 \
  ...
  -validity 3650 -keystore certs/ca.p12 -storetype PKCS12 \
...
```
keytool -exportcert -alias ca -keystore certs/ca.p12 -storepass changeit \
...
keytool -genkeypair -alias server -keyalg RSA -keysize 2048 \
  ...
  -validity 825 -keystore certs/server.p12 -storetype PKCS12 \
  -storepass changeit -keypass changeit \
...
```
keytool -certreq -alias server -keystore certs/server.p12 -storepass changeit \
...
```
keytool -gencert -alias ca -keystore certs/ca.p12 -storepass changeit \
...
```
keytool -importcert -alias ca -keystore certs/server.p12 -storepass changeit \
  -noprompt -file certs/ca.crt

keytool -importcert -alias server -keystore certs/server.p12 -storepass changeit \
...
keytool -genkeypair -alias client -keyalg RSA -keysize 2048 \
  ...
  -validity 825 -keystore certs/client.p12 -storetype PKCS12 \
  -storepass changeit -keypass changeit
```
...
```
keytool -certreq -alias client -keystore certs/client.p12 -storepass changeit \
...
```
keytool -importcert -alias ca -keystore certs/client.p12 -storepass changeit \
  -noprompt -file certs/ca.crt

keytool -importcert -alias client -keystore certs/client.p12 -storepass changeit \
...
```
keytool -importcert -alias ca -keystore certs/server-trust.p12 -storetype PKCS12 \
...
```
keytool -importcert -alias ca -keystore certs/client-trust.p12 -storetype PKCS12 \
  -storepass changeit -noprompt -file certs/ca.crt
```
...
keytool -genkeypair -alias client-bad -keyalg RSA -keysize 2048 \
  ...
  -validity 825 -keystore certs/client-bad.p12 -storetype PKCS12 \
  -storepass changeit -keypass changeit
```
